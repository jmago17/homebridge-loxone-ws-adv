...
var IRCV2Item = function(widget, platform, homebridge) {
    ...
    if(this.name.startsWith("Pasillo") !== -1){ // this.stateMode = '1a99ffce-01d2-26ce-ffff8795bbcbc15c';
    }
    if(this.name.startsWith("Cocina") !== -1){  this.stateMode = '10779045-01b8-1068-ffff8795bbcbc15c';}
