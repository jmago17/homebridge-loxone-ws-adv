...
const occupan = function(widget,platform,homebridge) {
    ...
    occupan.super_.call(this, widget,platform,homebridge);
};

// Register a listener to be notified of changes in this items value
occupan.prototype.initListener = function() {
    this.platform.ws.registerListenerForUUID(this.stateUuid, this.callBack.bind(this));
};

occupan.prototype.callBack = function(value) {
...
occupan.prototype.getOtherServices = function() {
